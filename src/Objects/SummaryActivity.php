...
class SummaryActivity
{
    ...
    public static function create(array $parameters): self
    {
        ...
        $instance->resourceState = isset($parameters['resourceState']) ? (int)$parameters['resourceState'] : null;
        $instance->externalId = isset($parameters['externalId']) ? (int)$parameters['externalId'] : null;
        $instance->uploadId = isset($parameters['uploadId']) ? (int)$parameters['uploadId'] : null;
